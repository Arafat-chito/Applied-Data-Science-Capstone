...
app.layout = html.Div(children=[
    ...
    # TASK 1: Dropdown list to enable Launch Site selection (UNCOMMENTED & FIXED)
    ...
    # TASK 2: Pie chart to show the total successful launches count
    html.Div(dcc.Graph(id='success-pie-chart')),
    html.Br(),

    html.P("Payload range (Kg):"),
    
    # TASK 3: Slider to select payload range (UNCOMMENTED & FIXED)
